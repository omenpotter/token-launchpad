    ...
    <div className="space-y-6">
      ...
      <div className="bg-slate-800/50 rounded-2xl p-5 border border-slate-700/50">
        <div className="flex items-center gap-3 mb-4">
          ...
          <div>
            <h3 className="font-semibold text-white">Token Metadata (Optional)</h3>
            <p className="text-xs text-slate-400">Branding and social information - can be added later</p>
          </div>
        </div>
